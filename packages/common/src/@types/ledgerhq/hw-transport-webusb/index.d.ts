declare module '@ledgerhq/hw-transport-webusb' {
  ...
  export default class TransportWebUSB extends Transport<USBDevice> {
    ...
    /**
     * Similar to `open()`, but will always ask for device permissions, even if the device is
     * already accepted.
     *
     ...
     *
     * @return {Promise<TransportWebUSB | null>} A Promise with the Transport instance or null if
     *   no device was found.
     */
